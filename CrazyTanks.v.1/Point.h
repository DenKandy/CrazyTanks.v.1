...
const int START_PLAYER_HEALTH = 3;
const int START_ENEMY_HEALTH = 1;
const int START_WALL_HEALTH = 3;
const int COUNT_TANKS = 5;
...
const int SHOOT = 32;
const int EXIT = 27;
const int SLEEP_PLAYER = 50;
const int SLEEP_TANK = 500;
const int SLEEP_BULLET = 50;
